import AppExpenseTrackerCard from "./components/AppExpenseTrackerCard";
import { useState } from "react";
import AppExpenseTrackerHistory from "./components/AppExpenseTrackerHistory";
import AppExpenseTrackerForm from "./components/AppExpenseTrackerForm";
...
const ExpenseTracker = () => {
  ...
  return (
    <section className="mb-[15vh] w-full px-[6vw] font-exo text-[#2D2B2B]">
      ...
      <div className="mx-auto mt-5 flex h-full flex-col space-y-5 px-[6vw] md:w-[30rem] md:px-0">
        {/* Balance */}
